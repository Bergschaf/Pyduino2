...
static void createModuleCodeObjects(void) {
    ...
    codeobj_ece2c4e32b5b9f90555951b3092b54db = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[9], mod_consts[9], NULL, NULL, 0, 0, 0);
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        UPDATE_STRING_DICT0(moduledict___main__, (Nuitka_StringObject *)mod_consts[7], tmp_assign_source_7);
    }
    {
